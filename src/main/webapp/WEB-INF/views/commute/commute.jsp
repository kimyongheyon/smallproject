			...
			<body onload="printClock()">
				...
				<div class="container-box">
					<div style="width: 100%; height: 50px">
						<h2 style="font-size: 2rem; font-weight: 400; float: left; display: inline; line-height: 50px">
							출퇴근 관리</h2>
					...
					<div class="top-box">
						...
						<div class="list-btn-box">
							<button class="list-btn" onclick="monthtimelist();">month-list</button>
							<button class=list-btn onclick="alltimelist();">all-list</button>
						</div>

						<div id="sumbit-box">

							<input type="text" value="${checkInt}" id="commuteCheck">
							<input type="text" value="${timeCheck}" id="timeCheck">
							...
							<c:if test="${v == 1 && todayCheck == 1}">
								<form action="commuteEndUpdate.do" method="post" style="display: inline-block;">
					...
					<div class="bottom-box">
						<div class="commute-list-location">
							<div id="alltimelist" class="commutelist-box">
								<h1 style="display: inline;  font-family: 'Roboto', sans-serif;">출퇴근 전체 리스트</h1>
							</div>
							<div id="monthlist" style="width: 600px;">
								<button type="button" onclick="lastMonth();" class="table-btn">지난 달</button>
								<h1 style="display: inline;"><strong><span id="number"
											style=" font-family: 'Roboto', sans-serif;"></span></strong></h1>
								<h1 style="display: inline;  font-family: 'Roboto', sans-serif;">월</h1>
